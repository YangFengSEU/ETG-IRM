...
scene_dict = {
    "EP":"/home/lb/Documents/unidataset/lastversion/processed/EPR3s/",
    "FT":"/home/lb/Documents/unidataset/lastversion/processed/FT3s/",
    "SR":"/home/lb/Documents/unidataset/lastversion/processed/SR3s/",
    "LN":"/home/lb/Documents/unidataset/lastversion/processed/LN3s/",
    "GL":"/home/lb/Documents/unidataset/lastversion/processed/GL3s/",
    "MA":"/home/lb/Documents/unidataset/lastversion/processed/MA3s/",
    "EP0":"/home/lb/Documents/unidataset/lastversion/processed/EP3s/",
    "GL":"/home/lb/Documents/unidataset/lastversion/processed/GL3s/",
    "OF":"/home/lb/Documents/unidataset/lastversion/processed/OF3s/",
}
...
logging.info(f'train set:{args.train_data1},train set:{args.train_data2},test set:{args.test_data}')
# Initialize network
...
print(scene_dict[args.train_data1])
trSet=UniDataset(os.path.join(scene_dict[args.train_data1],'train/'),os.path.join(scene_dict[args.train_data2],'train/'),city1=args.train_data1,city2=args.train_data2)
testSet=UniDataset1(os.path.join(scene_dict[args.test_data],'val/'),city=args.test_data)
        ...
        for edx, env in enumerate(envs):
            ...
            if args.algorithm=='irm':
                if not args.use_maneuvers:
                    ...
                    # # maneuver_types.append(maneuver.cpu().detach().numpy())
                    ...
                    env['irm'] = penaltydest(generated_dest, dest, dest_mask)# maneuver, motiva, args.env_num
